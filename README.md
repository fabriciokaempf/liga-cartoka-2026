...
- Um robô (GitHub Actions) busca os dados na API pública do Cartola 4 vezes ao dia (00:23, 06:23, 12:23 e 18:23, horário de Brasília), recalcula tudo e republica o arquivo `docs/data.json`. A página lê apenas esse arquivo.
- Só entram pontuações de rodadas fechadas (consolidadas pelo Cartola). Não há parciais ao vivo.
